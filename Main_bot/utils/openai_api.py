...
async def openai_request(symbol):
    ...
    completion = client.chat.completions.create(
        ...
        messages=[
            {"role": "system",
             "content": "You are a cryptocurrency expert, skilled in explaining complex concepts with creative flair. A cryptocurrency trader asks you what your project is and what its prospects are. Answer in English and only in 3 paragraphs, no more than 4000 characters."},
            {"role": "user",
